...
<html lang="en">
	...
	<body>
			...
			<h1>Meet Creative Corrie</h1>
			<h1>as the Hackey Hooker</h1>
		<div class="boxtitle">Define:</div>
		<div class="box">
			<p>PURPOSE: Hi, I'm Corrie Hooker and I build websites that are easy to use. I can help offer you and your clients a great online experience.</p>
			<p>AUDIENCE:</p>
			<p>Clients who are looking for a professional and well rounded coder who is also easy to work with</p>
			<p>WEBSITE GOAL:</p>
			<p>The goal of this website is to showcase my talent, skills and work.</div>
