				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-right">
							<li><a href="#">My Art Site</a></li>
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Menu <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="http://creativecorrie.com/">Home</a></li>
									<li><a href="http://creativecorrie.com/about/">About</a></li>
									<li><a href="http://creativecorrie.com/my-work/">My Work</a></li>
									<li role="separator" class="divider"></li>
									<li><a href="http://creativecorrie.com/my-services/">My Services</a></li>
									<li role="separator" class="divider"></li>
									<li><a href="http://creativecorrie.com/contact/">Contact Me</a></li>
...
<!--****=============================================================****-->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading"><a name="Education">Educational highlights.</a>
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading"><a name="Samples">And lastly, great examples of my work.</a>
